...
const getEnvironmentConfig = () => {
    ...
    const config = {
      ...
      production: {
        ...
        apiUrl: import.meta.env.VITE_API_URL || 'https://pwd-week6-server-muma.onrender.com',
        clientUrl: import.meta.env.VITE_CLIENT_URL || 'https://pwd-week6-juunghaa.vercel.app',
      }
    };
